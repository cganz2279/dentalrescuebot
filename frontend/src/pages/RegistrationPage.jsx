...
const RegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Check for letters and numbers (matching backend validation)
    if (!/[A-Za-z]/.test(formData.adminPassword)) {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        } else if (errorMessage.includes('Password must be at least 6 characters with letters and numbers')) {
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="6+ characters with letters & numbers"
                    />
                    <button
                      type="button"
