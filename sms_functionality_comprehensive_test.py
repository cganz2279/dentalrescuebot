                        ...
                        if response.status_code == 200:
                            ...
                            try:
                                ...
                                if 'Invalid \'To\' Phone Number' in error_detail or 'trial' in error_detail.lower():
                                    ...
                                    self.secure_link = f"https://patient-portal-45.preview.emergentagent.com/secure-pdf/mock-token-for-testing"
                                else:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    if 'Invalid \'To\' Phone Number' in error_detail:
                        ...
                        self.secure_link = f"https://patient-portal-45.preview.emergentagent.com/secure-pdf/test-token-{int(time.time())}"
                        return True
                    else:
