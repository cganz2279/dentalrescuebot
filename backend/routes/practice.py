...
async def get_practice_dashboard(current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        # Get recent patients (all patients, not just last 10)
        ...
        ).sort("createdAt", -1).to_list(length=None)  # Get ALL patients, not just 10
    ...
    try:
        ...
        if existing_override:
            ...
            override_data = {
                ...
                "overview": customization.overview or global_proc["overview"],
                "immediateAftercare": customization.immediateAftercare or global_proc["immediateAftercare"],
                "dietRestrictions": customization.dietRestrictions or global_proc["dietRestrictions"],
