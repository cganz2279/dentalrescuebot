...
def create_admin_guide_pdf():
    ...
    url_data = [
        ['Service', 'URL', 'Purpose'],
        ['Main App', 'https://admin-panel-debug-5.preview.emergentagent.com', 'Primary dental practice application'],
        ['Admin Console', 'https://admin-panel-debug-5.preview.emergentagent.com/admin', 'Full admin management interface'],
        ['HTML Admin Dashboard', 'https://admin-panel-debug-5.preview.emergentagent.com/api/admin/dashboard-html', 'Advanced admin dashboard (backup)']
    ]
    ...
    story.append(Paragraph("Base URL: https://admin-panel-debug-5.preview.emergentagent.com/api", code_style))
